...
```
新手路线：
ReAct → CoT/ToT → Plan-and-Solve → Multi-Agent → Reflexion → Retrieval → Memory → Function Calling

面试冲刺：
根据 JD 要求重点看对应范式和检索方案
一般重点：ReAct、Multi-Agent、Hybrid Retrieval、Memory System、Function Calling
```
