...
**新手**：ReAct → CoT/ToT → Plan-and-Solve → Multi-Agent → Retrieval → Memory → Function Calling

**面试冲刺**：按 JD 要求选读，高频考点：ReAct、Multi-Agent、混合检索、Memory System、Function Calling

## 🤝 贡献

欢迎 PR！格式要求：问题标题明确 · 含考察点分析 · 提供详细解答 · 有代码示例更佳
